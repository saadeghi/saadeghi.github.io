...
<div class="flex flex-col gap-12 lg:gap-20">
  ...
  <div class="flex flex-col items-center gap-10 lg:flex-row">
    ...
    <div class="flex flex-col gap-4 text-center lg:text-left">
      <h1 class="font-title text-4xl font-bold lg:text-6xl">
        {data.title}
      </h1>
  ...
  <div class="font-title text-3xl leading-snug lg:text-6xl lg:font-extralight lg:leading-tight [&_a]:border-b [&_a]:border-b-black">
  ...
  {#if data.photos && data.photos.length}
    <div class="grid grid-cols-1 gap-20">
      {#each data.photos as photo}
        <div class="flex max-h-screen items-center justify-center rounded bg-slate-900 p-20">
